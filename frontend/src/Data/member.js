export const frontExample =
  "https://images-ext-2.discordapp.net/external/_0ymjNXetQH57BtUs0bSzfAQ8gEYCdUpwejezpLtmsA/https/upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Meisje_met_de_parel.jpg/300px-Meisje_met_de_parel.jpg";

export const backExample =
  "https://images-ext-2.discordapp.net/external/fZW0LjwR-K_8TCrNNyCGxwMfwZuBWxRvh3Ed0yh_uRU/%3Fq%3Dtbn%3AANd9GcSlpEGOnCW_ew102--j2y_-6O1pYhe-3M7muA%26usqp%3DCAU/https/encrypted-tbn0.gstatic.com/images";
...
export const members = [
  ...
  },
  {
    ...
    role: "Backend, Infra",
    introduce: [
      "Data Scentist로 일 하다가 개발자로 커리어를 전향했습니다.",
  ...
  },
  {
    ...
    role: "Frontend",
    introduce: [
      "2021년 올해 처음 프로그래밍을 도전하게 되었고, 프론트 개발자로서의 길을 시작하게되었습니다.",
      "프론트엔드 분야는 알면 알수록 공부할것이 참 많아서 힘들지만 응용해보면 새로운 결과가 나와서 흥미를 느꼈습니다.",
